...
<form id="form1" name="form1" method="post" action="purchase_insert_cfrm.jsp">
<table width="550" height="387" border="10" align="center">
  <tr>
    <td colspan="2" align="center" >商品采购信息添加</td>
  </tr>
  <tr>
    <td width="269">采购编号</td>
    <td width="304"><input type="text" name="PurId" id="textfield" ></td>
  </tr>
    </tr>
    <tr>
    <td >商品编号</td>
    <td ><input type="text" name="ProId" id="textfield" ></td>
  </tr>
  <tr>
    <td>商品名称</td>
    <td><input type="text" name="ProName" id="textfield" ></td>
  <tr>
    <td>联系人编号</td>
    <td><input type="text" name="SalerId" id="textfield" ></td>
  </tr>
  <tr>
    <td>公司采购员编号</td>
  ...
  <tr>
    <td>单价</td>
    <td><input type="text" name="Price" id="textfield" ></td>
  </tr>
  <tr>
    <td>时间</td>
    <td><input type="text" name="Data" id="textfield" ></td>
  </tr>
  <tr>
    <td>地址</td>
    <td><input type="text" name="Address" id="textfield" ></td>
  </tr>
  <tr>
    <td>描述</td>
    <td>
