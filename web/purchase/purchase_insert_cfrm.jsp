...
%>
<jsp:useBean id="purchase1" scope="session" class="purchase.PurchaseBean1"/>
<%
	int result = purchase1.InsertPurchase(PurId,ProId,ProName,SalerId,EmpId,Price,Quantity,Data,Address,Memo);
	if( result==1 )
	{
		out.println( "添加成功！" );
	}
