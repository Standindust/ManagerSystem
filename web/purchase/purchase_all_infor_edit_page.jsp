...
<table width="566" height="126" border="10" align="center">
  <tr>
    <td colspan="9">采购信息编辑</td>
  </tr>
  <tr>
    <td width="42" height="35">采购编号</td>
	<td width="61">商品名称</td>
    <td width="77">联系人编号</td>
    <td width="80">采购员编号</td>
    <td width="44">数量</td>
    <td width="49">单价</td>
    <td width="50">时间</td>
    <td width="45">修改</td>
...
%>
  ...
  <tr>
    <td height="34">&nbsp;<%=rs.getString("PurId")%></td>
    ...
    <td><a href="purchase_update.jsp?PurId=<%=rs.getString("PurId")%>">修改</td>
    <td><a href="purchase_delete_cfrm.jsp?PurId=<%=rs.getString("PurId")%>" onClick="javascript:return (linkcheck())">删除</td>
  </tr>
<%
				i++;
			}
...
<form method="get" action="purchase_all_infor_edit_page.jsp">
<a href="purchase_all_infor_edit_page.jsp">返回</a>
共<%=totalpage%>页&nbsp;
<%
if(curpage>1 && totalpage>1)
	out.print("<a href=\"purchase_all_infor_edit_page.jsp?page="+ (curpage-1)+"\">上一页</a>");
else
	out.print("上一页");
%>&nbsp;
<%
if(curpage<totalpage)
	out.print("<a href=\"purchase_all_infor_edit_page.jsp?page="+ (curpage+1)+"\">下一页</a>");
else
	out.print("下一页");
%>
