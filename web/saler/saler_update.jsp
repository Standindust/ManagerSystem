...
请输入要修改的供应商联系人编号：
<form id="form1" name="form1" method="POST" action="saler_update.jsp">
  <label>
...
<form id="form2" name="form2" method="post" action="saler_update_cfrm.jsp">
<table width="500" height="387" border="10" align="center">
  <tr>
    <td colspan="2" align="center">联系人信息	  
      <input type="hidden" name="SalerId1" value="<%=convert(saler1.getSalerId())%>" /></td>
  </tr>
  <tr>
    <td width="269">联系人编号</td>
    <td width="304"><input type="text" name="SalerId" id="textfield" disabled="disabled" value="<%=convert(saler1.getSalerId())%>"></td>
  </tr>
      <tr>
    <td>供货厂家编号  <input type="hidden" name="SupId" value="<%=saler1.getSupId()%>" /></td>
    <td><input type="text" name="SupId" id="textfield" value="<%=saler1.getSupId()%>" disabled="disabled"></td>
  </tr>
  
  <tr>
    <td>联系人姓名</td>
    <td><input type="text" name="SalerName" id="textfield" value="<%=saler1.getSalerName()%>" ></td>
  </tr>
 ...
 %>
  ...
  <tr>
    <td>职位</td>
    <td><input type="text" name="Title" id="textfield"value="<%=saler1.getSalerTitle()%>" ></td>
  </tr>
  <tr>
    <td>办公室电话</td>
    <td><input type="text" name="Office" id="textfield" value="<%=saler1.getSalerOffice()%>" ></td>
  </tr>
  <tr>
    <td>移动电话</td>
    <td><input type="text" name="Mobile" id="textfield" value="<%=saler1.getSalerMobile()%>" ></td>
  </tr>
  <tr>
    <td>联系人爱好</td>
    <td><input type="text" name="Hobby" id="textfield" value="<%=saler1.getSalerHobby()%>" ></td>
  </tr>
  <tr>
    <td>描述</td>
    <td>
      <textarea name="Memo" cols="50" rows="5" id="label"><%=saler1.getSalerMemo()%></textarea>
        </td>
  </tr>
    <tr>
    <td>
