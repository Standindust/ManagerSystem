...
<jsp:useBean id="departmentsbean" class="departments.DepartmentsBean" scope="page" />
<%
	java.util.Vector departments = departmentsbean.queryDepartments( );
	
	if( null==departments)
	{
		out.println( "没有找到部门信息！" );
	}
	else
	{
%>
<table width="474" height="110"  border="12" align="center" cellspacing="1" >
  <tr>
    <td colspan="3"><div align="center" class="style1">所有部门基本信息</div></td>
  </tr>
  <tr>
    <td width="171"  height="30">部门编号</td>
    <td width="148" >部门名称</td>
    <td width="115" >修改该部门信息</td>
  </tr>
<%
		for( int i=0; i<departments.size(); i++ )
		{
			Departments d = (Departments)departments.get( i );
%>

  <tr>
    <td height="30"><%=d.getDepId()%></td>
    <td><%=d.getDepName()%></td>
    <td><a href="Departments_Update.jsp?DepId=<%=d.getDepId()%>">修改</td>
  </tr>
<%
		}
%>
