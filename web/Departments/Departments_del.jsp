...
<!--Your Company Name-->企业人力资源部——人事部</font></b></font></div>
          </td>
          <td height="30" width="170">&nbsp;</td>
        </tr>
        <tr> 
...
请输入要修改的部门编号：
<form id="form1" name="form1" method="POST" action="Departments_del.jsp">
  <input type="text" name="DepId" value="" />
  <input type="submit" name="Submit" value="查询" />
  <input type="reset" name="Submit2" value="重新设置" /> 
</form>
<jsp:useBean id="Departments" scope="session" class="departments.DepartmentsBean"/>
<%
  String DepId=request.getParameter("DepId");
 if(DepId!=null)
 {
  Departments Dep1 = Departments.getDepartmentsDetails(DepId);
  if(Dep1==null)
  out.println("不存在该部门的基本信息");
  else
  {
%>
<table width="459"   border="12"  height="120" align="center" cellspacing="1" >
  <tr>
    <td colspan="3" height="40"><div align="center" class="style1">部门基本信息</div></td>
  </tr>
  <tr>
    <td width="156" height="30">部门编号</td>
    <td width="196">部门名称</td>
    <td width="67" >删除该部门信息</td>
  </tr>
  <tr>
    <td height="40"><%=Dep1.getDepId()%></td>
    <td><%=Dep1.getDepName()%></td>
    <td><a href="Departments_del_cfrm.jsp?DepId=<%=Dep1.getDepId()%>">删除</a></td>
  </tr>
</table>
<%
  }
