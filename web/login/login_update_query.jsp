...
{  
	...
	if( mainform.UserId.value.length==0 )
	{
		alert( "请输入用户编号！" );
...
<form id="form2" name="form2" method="post" action="login_update_in.jsp">
  <table width="405" height="265" border="12" align="center" bordercolor="#993333">
    <tr>
      <td colspan="2" align="center" >请输入用户个人登陆信息 </td>
    </tr>
    <tr>
      <td width="181">用户编号</td>
      <td width="208"><input type="text" name="UserId" id="textfield" />      </td>
    <tr>
      <td width="181">用户姓名</td>
      <td width="208"><input type="text" name="UserName" id="textfield" />      </td>
    </tr>
    <tr>
      <td>密码</td>
    ...
    <tr>
      <td height="64"><input type="submit" name="Submit3" value="查询" id="Submit" onClick="javascript:return (checkvalue());" />      </td>
      <td><input type="reset" name="Reset" value="重填" id="Submit" />      </td>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../menu_index/personnael_department_index.jsp">人力资源部</a>※<a href="../menu_index/finance_department_index.jsp">公司财务部</a>※<a href="../menu_index/purchase_department_index.jsp">商品采购部</a>※<a href="../menu_index/sale_department_index.jsp">商品销售部</a>※<a href="../menu_index/common_employee_index.jsp">个人信息管理</a></p>
