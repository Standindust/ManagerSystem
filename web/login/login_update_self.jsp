...
<form id="form2" name="form2" method="post" action="login_update_self_cfrm.jsp">
  <table width="424" height="212" border="12" align="center" bordercolor="#993333" >
    <tr>
      <td colspan="2" align="center">用户权限修改 <input type="hidden" name="UserId1" value="<%=convert(login1.getUserId())%>"></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
      <td height="64"><input type="submit" name="Submit3" value="修改" id="Submit" />
      </td>
