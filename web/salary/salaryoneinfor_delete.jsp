...
请输入员工工资编号进行查询：
<form id="form1" name="form1" method="POST" action="salaryoneinfor_delete.jsp">
  <label>
...
<%
 // out.println("SupId="+SupId);
  ...
  if(salary1==null)
  out.println("不存在该员工的工资信息");
  else
  {
%>
<form id="form2" name="form2" method="post" action="salary_delete_cfrm.jsp">
<table width="520" height="339" border="12" align="center">
  <tr>
    <td colspan="2" align="center">员工工资信息
      <input type="hidden" name="SalaryId1" value="<%=salary1.getSalaryId()%>"></td>
  </tr>
  <tr>
    <td width="451">工资编号</td>
    <td width="176">&nbsp;<%=salary1.getSalaryId()%></td>
  ...
  <tr>
    <td>时间</td>
    <td>&nbsp;<%=salary1.getSalaryTime()%></td>
  </tr>
   <tr>
    <td>&nbsp;<input type="submit" name="Submit" value="删除" /></td>
    <td>&nbsp;<input type="button" name="Button" value="取消" /></td>
  </tr>
</table>
</form>
<%
