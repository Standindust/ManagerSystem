        ...
        <tr> 
          <td align="center"> 
            <table width="176" border="0" cellspacing="0" cellpadding="0" class="button">
              <tr> 
                <td height="27" width="46">&nbsp;</td>
                <td height="27" width="130"><b><a href="../login/index_one_person.jsp"><font color="#FFFFFF"><span class="text">个人信息咨询
                  </span></font></a></b></td>
              </tr>
            </table>
          </td>
...
<form id="form1" name="form1" method="POST" action="salaryoneinfor_query_oneperson.jsp">
  <label>
