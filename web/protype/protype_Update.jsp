...
<%
  Protype protype1 = protype.getProtypeDetails(TypeId);
%>


<form id="form1" name="main" method="post" action="protype_Update_cfrm.jsp" >
<table width="493" height="142" border="12" align="center" >
  <tr>
    <td colspan="2" align="center">商品类型信息的修改
      <input type="hidden" name="TypeId" value="<%=convert(protype1.getTypeId())%>">
    </td>
  </tr>
  <tr>
    <td width="254" height="31">商品类型编号</td>
    <td width="226">
<input type="text" name="TypeId" value="<%=convert(protype1.getTypeId())%>"  disabled="disabled" />
    </td>
  </tr>
  <tr>
    <td height="26" class="style2">商品类型名称</td>
    <td><input type="text" name="TypeName" value="<%=protype1.getTypeName()%>"  />
	</td>
  </tr>
  <tr>
    <td height="27">
