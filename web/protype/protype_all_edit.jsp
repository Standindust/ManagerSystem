...
<jsp:useBean id="protype" class="protype.ProtypeBean" scope="page" />
<%
	java.util.Vector pro = protype.queryProtype();
	
	if( null==pro)
	{
		out.println( "没有找到商品类型信息！" );
	}
	else
	{
%>
<table width="379" height="129"  border="12" align="center"  >
  <tr>
    <td colspan="3" align="center" >所有商品类型基本信息</td>
  </tr>
  <tr>
    <td width="107" height="38">商品类型编号</td>
    <td width="135">商品类型名称</td>
    <td width="93" class="style2">修改该商品类型信息</td>
  </tr>
<%
		for( int i=0; i<pro.size(); i++ )
		{
			Protype p = (Protype)pro.get( i );
%>

  <tr>
    <td height="38"><%=p.getTypeId()%></td>
    <td><%=p.getTypeName()%></td>
    <td><a href="protype_Update.jsp?TypeId=<%=p.getTypeId()%>">修改</td>
  </tr>
<%
		}
%>
