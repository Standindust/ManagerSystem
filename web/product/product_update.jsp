...
<% 
String ProId1 =request.getParameter("ProId1");
...
<%
	int result = product.updateProduct(ProId1,ProName,TypeId,ProUnit,NowPrice,ProPrice,Quantity,Memo);
	if( result==1 )
	{
		out.println( "修改成功！" );
	}
