...
<table width="674" height="166" border="12" align="center">
  <tr>
    <td colspan="8" align="center">所有商品的基本信息</td>
  </tr>
  <tr>
    <td width="67">商品编号</td>
...
%>
  <tr>
    ...
    <td><a href="product_delete.jsp?ProId=<%=rs.getString("ProId")%>" onClick="javascript:return (linkcheck())">删除</a></td>
  </tr>
<%
				i++;
			}
...
<form method="get" action="product_allinfor_del.jsp">
<a href="product_allinfor_del.jsp">返回</a>
共<%=totalpage%>页&nbsp;
<%
if(curpage>1 && totalpage>1)
	out.print("<a href=\"product_allinfor_del.jsp?page="+ (curpage-1)+"\">上一页</a>");
else
	out.print("上一页");
%>&nbsp;
<%
if(curpage<totalpage)
	out.print("<a href=\"product_allinfor_del.jsp?page="+ (curpage+1)+"\">下一页</a>");
else
	out.print("下一页");
%>
