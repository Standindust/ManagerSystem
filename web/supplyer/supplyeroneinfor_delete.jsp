...
请输入要删除的供应商厂家编号，进行查询：
<form id="form1" name="form1" method="POST" action="supplyeroneinfor_delete.jsp">
  <label>
...
<form id="form2" name="form2" method="POST" action="supplyeroneinfor_delete_cfrm.jsp">
<table width="526" height="244" border="12" align="center">
  <tr>
    <td colspan="2" align="center"> 供应商厂家信息
      <input type="hidden" name="SupId" value="<%=supplyer1.getSupId()%>" ></td>
  </tr>
  <tr>
    <td width="262">供应商厂家编号</td>
    <td width="268">&nbsp;<%=convert(supplyer1.getSupId())%></td>
  </tr>
  <tr>
    <td>供应商厂家名称</td>
  ...
  <tr>
    ...
    <td>&nbsp;<input type="button" name="Button" value="取消" />
    </td>
  </tr>
</table>
</form>
