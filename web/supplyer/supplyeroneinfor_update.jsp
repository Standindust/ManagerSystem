...
请输入要修改的供应商编号：
<form id="form1" name="form1" method="POST" action="supplyeroneinfor_update.jsp">
  <label>
...
<%
 // out.println("SupId="+SupId);
  ...
  if(supplyer1==null)
  out.println("不存在该供应商信息");
  else
  {
%>

<form id="form2" name="form2" method="POST" action="supplyeroneinfor_update_cfrm.jsp">
<table width="526" height="307" border="12">
  <tr>
    <td colspan="2" align="center"> 供应商厂家信息
      <input type="hidden" name="SupId" value="<%=supplyer1.getSupId()%>"></td>
  </tr>
  <tr>
    <td width="281">供应商厂家编号</td>
    <td width="438">
      <input type="text" name="SupId" id="textfield" value="<%=convert(supplyer1.getSupId())%>" disabled="disabled"></td>
  </tr>
  <tr>
    <td>供应商厂家名称</td>
    <td><input type="text" name="SupName" id="textfield" value="<%=supplyer1.getSupName()%>"></td>
  </tr>
  <tr>
    <td>供应商厂家地址</td>
    <td><input type="text" name="Address" id="textfield" value="<%=supplyer1.getAddress()%>" ></td>
  </tr>
  <tr>
    <td>供应商厂家邮编</td>
    <td><input type="text" name="Postcode" id="textfield" value="<%=supplyer1.getPostcode()%>" ></td>
  </tr>
  <tr>
    <td>生产的产品名称</td>
    <td> <input type="text" name="ProductName" id="textfield" value="<%=supplyer1.getProductName()%>"></td>
  </tr>
    <tr>
    <td>&nbsp;<input type="submit" name="Submit" value="修改" /></td>

    <td>&nbsp;<input type="reset" name="Reset" value="重填" />
    </td>
  </tr>
</table>
</form>
