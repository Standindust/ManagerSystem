...
<!--Button7-->退出系统</a></b></div>                </td>
              </tr>
            </table>
<!--Button7.Content.End-->          </td>
        </tr>
      </table>    </td>
...
<%
 ...
 <%
 int nResult=supplyer.updateSupplyer(SupId,SupName,Address,Postcode,ProductName);
 if(nResult==1)
 {
 out.println("修改成功！修改后的供应商信息如下：");
 Supplyer supplyer1 = supplyer.getSupplyerDetails(SupId);
 %>
 
   <table width="526" height="307" border="12" align="center">
     <tr>
     ...
     <tr>
       ...
       <td width="438">&nbsp;<%=convert(supplyer1.getSupId())%></td>
     </tr>
     <tr>
       <td>供应商厂家名称</td>
