...
<table width="552" height="128" border="12" align="center">
  <tr>
    <td height="35" colspan="7" align="center">员工所有考勤信息</td>
  </tr>
  <tr>
    <td width="49" height="39">EvaId</td>
    <td width="72">EmpId</td>
    <td width="100">EmpName</td>
    <td width="105">EvaDate</td>
 ...
 %>
  <tr>
    <td height="37">&nbsp;<%=rs.getString("EvaId")%></td>
...
<form method="get" action="evaluation_index.jsp">
<a href="evaluation_index.jsp">返回</a>
共<%=totalpage%>页&nbsp;
<%
if(curpage>1 && totalpage>1)
	out.print("<a href=\"evaluation_index.jsp?page="+ (curpage-1)+"\">上一页</a>");
else
	out.print("上一页");
%>&nbsp;
<%
if(curpage<totalpage)
	out.print("<a href=\"evaluation_index.jsp?page="+ (curpage+1)+"\">下一页</a>");
else
	out.print("下一页");
%>
