...
<table width="800" height="138" border="12">
  <tr>
    <td colspan="9" align="center">所有员工的基本信息</td>
  </tr>
   <tr>
    <td width="50">员工编号</td>
    <td width="70">员工姓名</td>
...
%> 
 ...
 <tr>
	...
	<td align="center"><%=rs.getString("Original")%></td>
    <td align="center"><%=rs.getString("faceinfo")%></td>
	<td align="center"><a href="employee_delete_cfrm.jsp?EmpId=<%=rs.getString("EmpId")%>" onClick="javascript:return (linkcheck())">删除</a>
	</td>
...
<form method="get" action="employees_many_del.jsp">
<a href="employees_many_del.jsp">返回</a>
共<%=totalpage%>页&nbsp;
<%
if(curpage>1 && totalpage>1)
	out.print("<a href=\"employees_many_del.jsp?page="+ (curpage-1)+"\">上一页</a>");
else
	out.print("上一页");
%>&nbsp;
<%
if(curpage<totalpage)
	out.print("<a href=\"employees_many_del.jsp?page="+ (curpage+1)+"\">下一页</a>");
else
	out.print("下一页");
%>
