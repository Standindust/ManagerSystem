...
<table width="536" height="514" border="12" >
  ...
  <tr>
    ...
    <td>
      <select name="bumen" size="1" id="select" >
		...
		<option  value="2">商品销售部</option>
        <option value="3">商品采购部</option>
		<option  value="4">公司财务部</option>
		<option  value="5">企业规划部</option>
	    <option  value="6">企业其他部门</option>
      </select>
    </td>
  <tr>
    <td>性别</td>
  ...
  <tr>
    ...
    <tr>
    <td>&nbsp; <input type="submit" name="add" value="添加" onClick="javascript:return (checkvalue());" /></td>
