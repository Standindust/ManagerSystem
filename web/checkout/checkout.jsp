...
%>
<jsp:useBean id="checkout01" class="checkout.CheckoutBeanPage" scope="session" />
...
<table width="720" height="149" border="12" align="center">
  <tr>
    <td height="38" colspan="7" align="center">商品的销售信息</td>
  </tr>
  <tr>
 ...
 <%
	...
	int totalpage = checkout01.totalPage(pgsize);
	
	try{
		ResultSet rs = checkout01.getPageof(pg, pgsize);
		if(rs != null) {
...
<a href="checkout.jsp">返回</a>
共<%=totalpage%>页&nbsp;
<%
if(curpage>1 && totalpage>1)
	out.print("<a href=\"checkout.jsp?page="+ (curpage-1)+"\">上一页</a>");
else
	out.print("上一页");
%>&nbsp;
<%
if(curpage<totalpage)
	out.print("<a href=\"checkout.jsp?page="+ (curpage+1)+"\">下一页</a>");
else
	out.print("下一页");
%>
